							...
							<div class="item">
								<div class="media">
									<div class="media-left">
										<a href="<?php echo base_url('city/'.strtolower($origin->code).'/'.strtolower($city->code)); ?>">
									...
									<div class="media-body">
										...
										<ul class="info">
											<li><i class="fa fa-plane"></i> Travel from <strong><?php echo $origin->name.', '.country_name($origin->country); ?></strong> to <strong><?php echo $city->name.', '.country_name($city->country); ?></strong></li>
