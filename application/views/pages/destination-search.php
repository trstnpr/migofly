	...
	<section class="section-banner data-img" data-bg="<?php echo base_url('build/images/banner/banner-5.jpeg'); ?>">
		...
		<div class="overlay">
			...
			<div class="container">
				...
				<h1 class="page-title">Search for "<?php echo $_GET['keyword']; ?>"</h1>
			...
			<div class="row">
				...
				<div class="col-md-9 col-sm-8">
					...
					<div class="section-content">
						...
						<h2 class="section-title"><?php echo $count; ?> Result(s)</h2>
							...
							<div class="item">
								<div class="media">
									...
									<div class="media-body">
										...
										<ul class="info">
											<li><i class="fa fa-plane"></i> Travel from <strong><?php echo $user->name.', '.$user->country_name; ?></strong> to <strong><?php echo $city->name.', '.country_name($city->country); ?></strong></li>
