	...
	<section class="section-banner data-img" data-bg="<?php echo base_url('build/images/banner/banner-2.jpeg'); ?>">
		...
		<div class="overlay">
			...
			<div class="container">
				...
				<h1 class="page-title">Travel from <?php echo $origin->name.', '.country_city_code($origin->code).' to '.$city->name.', '.$city->country; ?></h1>
								...
								<div class="row">
									...
									<div class="col-sm-3 col-xs-6">
										...
										<div class="month-wrap data-img" data-bg="<?php echo base_url('build/images/banner/calendar.jpg'); ?>">
											<a href="<?php echo base_url('city/'.strtolower($origin->code).'/'.strtolower($city->code).'/'.$month); ?>">
												<div class="overlay">
