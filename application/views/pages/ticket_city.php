	...
	<section class="section-banner data-img" data-bg="<?php echo base_url('build/images/banner/banner-2.jpeg'); ?>">
		...
		<div class="overlay">
			...
			<div class="container">
				...
				<h1 class="page-title">Tickets for <?php echo $origin->name.', '.country_city_code($origin->code).' to '.$city->name.', '.$city->country; ?></h1>
												...
												<div class="row">
													...
													<div class="col-sm-6">
														...
														<div class="departure">
															<div class="info">
																...
																<p class="place"><?php echo $origin->name.', '.city_country_code($origin->code).' to '.$city->name.', '.$city->country; ?></p>
													...
													<div class="col-sm-6">
														...
														<div class="return">
															<div class="info">
																<label>Return</label>
																<p class="place"><?php echo $city->name.', '.$city->country.' to '.$origin->name.', '.city_country_code($origin->code); ?></p>
