				...
				<div class="panel-body">
					...
					<div class="row">
						...
						<div class="col-md-8">
							...
							<form class="form-horizontal userdetails-form" method="post" action="<?php echo base_url('admin/user/information'); ?>">
							    ...
							    <div class="form-group">
							        ...
							        <div class="col-sm-10">
							            <input type="text" class="form-control" name="first_name" value="<?php echo $user->first_name; ?>" placeholder="Your firstname ..." required />
							        </div>
							    </div>
							    <div class="form-group">
							        <label class="col-sm-2 control-label">Lastname</label>
							        <div class="col-sm-10">
							            <input type="text" class="form-control" name="last_name" value="<?php echo $user->last_name; ?>" placeholder="Your lastname" required />
							        </div>
							    </div>
							    <div class="form-group">
				...
				<div class="panel-body">
					...
					<div class="row">
						...
						<div class="col-md-8">
							...
							<form class="form-horizontal userpass-form" method="post" action="<?php echo base_url('admin/user/password'); ?>">
