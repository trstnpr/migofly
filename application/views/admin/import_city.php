		...
		<div class="container-fluid">
			...
			<div class="breadcrumb-wrap">
				<ol class="breadcrumb">
					...
					<li><a href="<?php echo base_url('admin/cities'); ?>">Tools</a></li>
					<li class="active">Import City</li>
				</ol>
			</div>
	...
	<section class="section-content">
		...
		<div class="container-fluid">
			...
			<div class="well">
				...
				<form class="cityimport-form" method="post" enctype="multipart/form-data" action="<?php echo base_url('admin/cities/import'); ?>">

					<div class="form-group">
						<label>File Input</label>
						<input type="file" name="city" accept=".csv" required />
						<p class="help-block">Import city data csv</p>
					</div>
