						    ...
						    <tbody>
						   	<?php foreach($categories as $category) { ?>
						        <tr>
						            ...
						            <td width="10%">
						            	<a href="<?php echo base_url('admin/category/edit/'.$category->id); ?>" class="btn btn-primary btn-xs btn-block">Edit</a>
						            	<button type="button" class="btn btn-danger btn-xs btn-block btn-delcat" data-delete="<?php echo $category->id; ?>" data-action="<?php echo base_url('admin/category/delete'); ?>">Delete</button>
						            </td>
						        </tr>
						    <?php } ?>
						    </tbody>
				...
				<div class="col-md-5 col-md-pull-7">
					...
					<div class="panel panel-success">
						...
						<div class="panel-body">
							...
							<form class="update-category" method="post" action="<?php echo base_url('admin/category/edit'); ?>">
