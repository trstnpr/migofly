<div class="pages-section">
	...
	<section class="section-content">
		...
		<div class="container-fluid">
			<form class="addaircraft-form" method="post" action="<?php echo base_url('admin/aircrafts/new'); ?>">
				<div class="row">
					<div class="col-md-9">
						<div class="well">
							<div class="row">
								...
								<div class="col-md-12">
									<div class="form-group">
										<label>Code</label>
										<input type="text" class="form-control" name="code" maxlength="3" placeholder="Enter code ..." required />
									</div>
								</div>
								<div class="col-md-12">
									<div class="form-group">
										<label>Slug</label>
										<input type="text" class="form-control slug" name="slug" placeholder="Aircraft slug ..." />
									</div>
								</div>
							</div>
						</div>
