<div class="pages-section">
	...
	<section class="section-content">
		...
		<div class="container-fluid">
			...
			<form class="addcity-form" method="post" action="<?php echo base_url('admin/cities/new'); ?>">
							...
							<div class="row">
								...
								<div class="col-md-6">
									<div class="form-group">
										...
										<input type="text" class="form-control slugcity to-upper" name="code" maxlength="3" placeholder="Enter city code ..." required />
									</div>
								</div>
								<div class="col-md-6">
									<div class="form-group">
