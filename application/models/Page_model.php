<?php
	...
	class Page_model extends CI_Model {
	    ...
	    public function get_active_pages($keyword=null)
	    {	

			if(isset($keyword)) {
				$this->db->where("(`title` LIKE '%".$keyword."%' OR `content` LIKE '%".$keyword."%' OR `excerpt` LIKE '%".$keyword."%' OR `meta_keyword` LIKE '%".$keyword."%' OR `meta_description` LIKE '%".$keyword."%')", NULL, FALSE);
			}
			$this->db->where('layout', 'page');
	    ...
	    public function get_active_pages_paginate($limit, $offset, $keyword=null)
	    {
	    ...
	    public function get_active_posts($keyword=null)
	    {
			if(isset($keyword)) {
				$this->db->where("(`title` LIKE '%".$keyword."%' OR `content` LIKE '%".$keyword."%' OR `excerpt` LIKE '%".$keyword."%' OR `meta_keyword` LIKE '%".$keyword."%' OR `meta_description` LIKE '%".$keyword."%')", NULL, FALSE);
			}
	    ...
	    public function get_active_posts_paginate($limit, $offset, $keyword=null)
	    {
	        $offset = ($offset > 0) ? ($offset - 1) * $limit : 0;
